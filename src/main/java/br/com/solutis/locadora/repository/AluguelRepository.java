...
public interface AluguelRepository extends JpaRepository<AluguelEntity, Long> {
    ...
    List<AluguelEntity> findAluguelEntitiesByDataEntregaGreaterThanEqualAndDataDevolucaoLessThanEqualAndCarro_Id(Date dataEntrega, Date dataDevolucao, Long carro);
